...
error_reporting(E_ALL);
  ...
  // Get all t titles
  $response = $database->query("SELECT * FROM superheroes WHERE id = $myid;");
  //var_dump($response);
  $profile = $response[0];
...
<div class="container">
  ...
  ?>
    ...
    <h3 class="my-4">Other Profiles</h3>

    <div class="row">

      <div class="col-md-3 col-sm-6 mb-4">
        <a href="luke_cage.php">
            <img class="img-fluid" src="<?php echo $profile['image'];?>" alt="iron man ">
          </a>
      </div>
      ...
      <div class="col-md-3 col-sm-6 mb-4">
        <a href="superman.php">
            <img class="img-fluid" src="<?php echo $profile['image'];?>" alt="spider man">
          </a>
      </div>
